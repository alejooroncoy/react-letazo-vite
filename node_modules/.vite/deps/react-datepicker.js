...
var Ne = { p: Ee, P: function(e2, t2) {
  ...
  return r2.replace("{{date}}", Pe(o, t2)).replace("{{time}}", Ee(a, t2));
} };
var xe = /P+p+|P+|p+|''|'(''|[^'])+('|$)|./g;
function Ye(e2) {
...
function Oe(e2, t2, r2, n, o) {
  ...
  return Array.isArray(t2) ? (t2.forEach(function(t3) {
    ...
    n && (i = Te(p, o) && e2 === Ie(p, t3, r2)), Te(p, o) && i && (a = p);
  }), a) : (a = parse(e2, t2, /* @__PURE__ */ new Date(), { locale: s }), n ? i = Te(a) && e2 === Ie(a, t2, r2) : Te(a) || (t2 = t2.match(xe).map(function(e3) {
    var t3 = e3[0];
    return "p" === t3 || "P" === t3 ? s ? (0, Ne[t3])(e3, s.formatLong) : t3 : e3;
  }).join(""), e2.length > 0 && (a = parse(e2, t2.slice(0, e2.length), /* @__PURE__ */ new Date())), Te(a) || (a = new Date(e2))), Te(a) && i ? a : null);
}
function Te(e2, t2) {
...
function nt(e2, t2) {
  return Ie(setQuarter(Ye(), e2), "QQQ", t2);
}
function ot(e2) {
  ...
  return dt(e2, { minDate: r2, maxDate: n }) || o && o.some(function(t3) {
    return ze(e2, t3);
...
function st(e2) {
  ...
  return dt(e2, { minDate: startOfMonth(r2), maxDate: endOfMonth(n) }) || o && o.some(function(t3) {
    return qe(e2, t3);
  }) || a && !a.some(function(t3) {
    return qe(e2, t3);
  }) || s && !s(Ye(e2)) || false;
...
function ct(e2) {
  ...
  return dt(i, { minDate: startOfYear(r2), maxDate: endOfYear(n) }) || o && o.some(function(e3) {
    return Ve(i, e3);
  }) || a && !a.some(function(e3) {
    return Ve(i, e3);
  }) || s && !s(Ye(i)) || false;
}
function lt(e2, t2, r2, n) {
...
function ht(e2) {
  ...
  return r2 && ut(e2, r2) || n && !ut(e2, n) || o && !o(e2) || false;
}
function mt(e2, t2) {
...
var Pt = function(t2) {
  ...
  function n() {
    ...
    return ye(ke(t3 = r2.call.apply(r2, [this].concat(a))), "state", { dropdownVisible: false }), ye(ke(t3), "renderSelectOptions", function() {
      ...
      return import_react2.default.createElement(Mt, { key: "dropdown", year: t3.props.year, onChange: t3.onChange, onCancel: t3.toggleDropdown, minDate: t3.props.minDate, maxDate: t3.props.maxDate, scrollableYearDropdown: t3.props.scrollableYearDropdown, yearDropdownItemNumber: t3.props.yearDropdownItemNumber });
...
var Et = react_onclickoutside_es_default(function(t2) {
  De(n, import_react2.default.Component);
  var r2 = Se(n);
  function n() {
    var t3;
...
var Nt = function(t2) {
  ...
  function n() {
    ...
    return ye(ke(t3 = r2.call.apply(r2, [this].concat(a))), "state", { dropdownVisible: false }), ye(ke(t3), "renderSelectOptions", function(t4) {
      ...
      return import_react2.default.createElement(Et, { key: "dropdown", month: t3.props.month, monthNames: r3, onChange: t3.onChange, onCancel: t3.toggleDropdown });
...
var Ot = function(t2) {
  ...
  function n() {
    ...
    return ye(ke(t3 = r2.call.apply(r2, [this].concat(a))), "state", { dropdownVisible: false }), ye(ke(t3), "renderSelectOptions", function() {
      ...
      return import_react2.default.createElement(Yt, { key: "dropdown", date: t3.props.date, dateFormat: t3.props.dateFormat, onChange: t3.onChange, onCancel: t3.toggleDropdown, minDate: t3.props.minDate, maxDate: t3.props.maxDate, scrollableMonthYearDropdown: t3.props.scrollableMonthYearDropdown, locale: t3.props.locale });
    }), ye(ke(t3), "renderScrollMode", function() {
      var e2 = t3.state.dropdownVisible, r3 = [t3.renderReadView(!e2)];
      return e2 && r3.unshift(t3.renderDropdown()), r3;
    }), ye(ke(t3), "onChange", function(e2) {
...
var Rt = function(t2) {
  ...
  function o() {
    ...
    for (var a = arguments.length, s = new Array(a), i = 0; i < a; i++)
      s[i] = arguments[i];
    return ye(ke(t3 = n.call.apply(n, [this].concat(s))), "MONTH_REFS", Ce(Array(12)).map(function() {
...
var Ft = function(t2) {
  ...
  function n() {
    ...
    return ye(ke(t3 = r2.call.apply(r2, [this].concat(a))), "state", { height: null }), ye(ke(t3), "handleClick", function(e2) {
      (t3.props.minTime || t3.props.maxTime) && mt(e2, t3.props) || (t3.props.excludeTimes || t3.props.includeTimes || t3.props.filterTime) && ht(e2, t3.props) || t3.props.onChange(e2);
      ...
      return t3.isSelectedTime(e2, r3, n2) && o2.push("react-datepicker__time-list-item--selected"), ((t3.props.minTime || t3.props.maxTime) && mt(e2, t3.props) || (t3.props.excludeTimes || t3.props.includeTimes || t3.props.filterTime) && ht(e2, t3.props)) && o2.push("react-datepicker__time-list-item--disabled"), t3.props.injectTimes && (60 * getHours(e2) + getMinutes(e2)) % t3.props.intervals != 0 && o2.push("react-datepicker__time-list-item--injected"), o2.join(" ");
      ...
      return r3.map(function(r4, o3) {
        ...
        }, tabIndex: "0", "aria-selected": t3.isSelectedTime(r4, l, d) ? "true" : void 0 }, Ie(r4, n2, t3.props.locale));
      });
    }), t3;
  }
...
ye(Ft, "calcCenterPosition", function(e2, t2) {
...
var At = function(t2) {
  ...
  function o(t3) {
    var a;
    return he(this, o), ye(ke(a = n.call(this, t3)), "YEAR_REFS", Ce(Array(a.props.yearItemNumber)).map(function() {
      return import_react2.default.createRef();
      ...
      var r2 = a.props, n2 = r2.date, o2 = r2.yearItemNumber, s = Ct(n2, o2).startPeriod;
      ...
      return (0, import_classnames.default)("react-datepicker__year-text", { "react-datepicker__year-text--selected": e2 === getYear(s), "react-datepicker__year-text--disabled": (n2 || o2 || i || p || c) && ct(e2, a.props), "react-datepicker__year-text--keyboard-selected": a.isKeyboardSelected(e2), "react-datepicker__year-text--today": a.isCurrentYear(e2) });
    }), ye(ke(a), "getYearTabIndex", function(e2) {
      return a.props.disabledKeyboardNavigation ? "-1" : e2 === getYear(a.props.preSelection) ? "0" : "-1";
    }), a;
  }
  return fe(o, [{ key: "render", value: function() {
    for (var t3 = this, r2 = [], n2 = this.props, o2 = Ct(n2.date, n2.yearItemNumber), a = o2.startPeriod, s = o2.endPeriod, i = function(n3) {
...
var Ht = function(t2) {
  ...
  function o(t3) {
    ...
    return he(this, o), ye(ke(a = n.call(this, t3)), "handleClickOutside", function(e2) {
      ...
      var e2 = a.props, t4 = e2.preSelection, r2 = e2.selected, n2 = e2.openToDate, o2 = wt(a.props), s = gt(a.props), i = Ye(), p = n2 || r2 || t4;
      ...
      a.props.onMonthChange && (a.props.onMonthChange(e2), a.setState({ isRenderAriaLiveMessage: true })), a.props.adjustDateOnChange && (a.props.onSelect && a.props.onSelect(e2), a.props.setOpen && a.props.setOpen(true)), a.props.setPreSelection && a.props.setPreSelection(e2);
      ...
      if (!a.props.renderCustomHeader) {
        ...
        switch (true) {
          ...
          case a.props.showYearPicker:
            t4 = function(e2) {
              var t5 = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}, r3 = t5.minDate, n3 = t5.yearItemNumber, o3 = void 0 === n3 ? 12 : n3, a2 = Ct(He(subYears(e2, o3)), o3).endPeriod, s2 = r3 && getYear(r3);
              return s2 && s2 > a2 || false;
            }(a.state.date, a.props);
            break;
          default:
            t4 = ft(a.state.date, a.props);
        }
      ...
      if (!a.props.renderCustomHeader) {
        ...
        switch (true) {
          ...
          case a.props.showYearPicker:
            t4 = function(e2) {
              var t5 = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}, r3 = t5.maxDate, n3 = t5.yearItemNumber, o3 = void 0 === n3 ? 12 : n3, a2 = Ct(addYears(e2, o3), o3).startPeriod, s2 = r3 && getYear(r3);
              return s2 && s2 < a2 || false;
            }(a.state.date, a.props);
            break;
          default:
      ...
      if (a.props.showMonthDropdown && !t4)
        return import_react2.default.createElement(Nt, { dropdownMode: a.props.dropdownMode, locale: a.props.locale, onChange: a.changeMonth, month: getMonth(a.state.date), useShortMonthInDropdown: a.props.useShortMonthInDropdown });
    }), ye(ke(a), "renderMonthYearDropdown", function() {
      var t4 = arguments.length > 0 && void 0 !== arguments[0] && arguments[0];
      if (a.props.showMonthYearDropdown && !t4)
        return import_react2.default.createElement(Ot, { dropdownMode: a.props.dropdownMode, locale: a.props.locale, dateFormat: a.props.dateFormat, onChange: a.changeMonthYear, minDate: a.props.minDate, maxDate: a.props.maxDate, date: a.state.date, scrollableMonthYearDropdown: a.props.scrollableMonthYearDropdown });
    }), ye(ke(a), "handleTodayButtonClick", function(e2) {
      a.props.onSelect(Qe(), e2), a.props.setPreSelection && a.props.setPreSelection(Qe());
      ...
      if (a.props.showTimeSelect && !a.state.monthContainer || a.props.showTimeSelectOnly)
        return null;
      var o2 = ft(a.state.date, a.props), s = yt(a.state.date, a.props), i = vt(a.state.date, a.props), p = Dt(a.state.date, a.props), c = !a.props.showMonthYearPicker && !a.props.showQuarterYearPicker && !a.props.showYearPicker;
      ...
      var t4 = a.state.date, r2 = a.props, n2 = r2.showYearPicker, o2 = Ct(t4, r2.yearItemNumber), s = o2.startPeriod, i = o2.endPeriod;
  ...
  return fe(o, [{ key: "componentDidMount", value: function() {
    ...
    !this.props.preSelection || ze(this.props.preSelection, e2.preSelection) && this.props.monthSelectedIn === e2.monthSelectedIn ? this.props.openToDate && !ze(this.props.openToDate, e2.openToDate) && this.setState({ date: this.props.openToDate }) : this.setState({ date: this.props.preSelection });
  } }, { key: "render", value: function() {
    var t3 = this.props.container || Bt;
  ...
  return fe(o, [{ key: "render", value: function() {
    ...
    if (!s) {
      ...
      t3 = import_react2.default.createElement(Popper, ve({ modifiers: p, placement: c }, l), function(t4) {
        ...
        return import_react2.default.createElement(Vt, { enableTabLoop: u }, import_react2.default.createElement("div", { ref: r2, style: n3, className: y, "data-placement": o3, onKeyDown: h }, import_react2.default.cloneElement(i, { arrowProps: a2 })));
      });
    }
    this.props.popperContainer && (t3 = import_react2.default.createElement(this.props.popperContainer, {}, t3)), m && !s && (t3 = import_react2.default.createElement(jt, { portalId: m, portalHost: f }, t3));
...
var zt = function(t2) {
  ...
  function a(t3) {
    var s;
    return he(this, a), ye(ke(s = o.call(this, t3)), "getPreSelection", function() {
      ...
      var e2, t4 = s.getPreSelection(), r2 = wt(s.props), n = gt(s.props), o2 = r2 && isBefore(t4, startOfDay(r2)) ? r2 : n && isAfter(t4, endOfDay(n)) ? n : t4;
      return { open: s.props.startOpen || false, preventFocus: false, preSelection: null !== (e2 = s.props.selectsRange ? s.props.startDate : s.props.selected) && void 0 !== e2 ? e2 : o2, highlightDates: kt(s.props.highlightDates), focused: false, shouldFocusDayInline: false, isRenderAriaLiveMessage: false };
    ...
    }), ye(ke(s), "setOpen", function(e2) {
      var t4 = arguments.length > 1 && void 0 !== arguments[1] && arguments[1];
      s.setState({ open: e2, preSelection: e2 && s.state.open ? s.state.preSelection : s.calcInitialState().preSelection, lastPreSelectChange: Gt }, function() {
    ...
    }), ye(ke(s), "handleFocus", function(e2) {
      ...
      if (!s.props.onChangeRaw || (s.props.onChangeRaw.apply(ke(s), t4), "function" == typeof n.isDefaultPrevented && !n.isDefaultPrevented())) {
        s.setState({ inputValue: n.target.value, lastPreSelectChange: $t });
        var o2 = Oe(n.target.value, s.props.dateFormat, s.props.locale, s.props.strictParsing, s.props.minDate);
        s.props.showTimeSelectOnly && !ze(o2, s.props.selected) && (o2 = set(s.props.selected, null == o2 ? { hours: getHours(s.props.selected), minutes: getMinutes(s.props.selected), seconds: getSeconds(s.props.selected) } : { hours: getHours(o2), minutes: getMinutes(o2), seconds: getSeconds(o2) })), !o2 && n.target.value || s.setSelected(o2, n, true);
      }
    }), ye(ke(s), "handleSelect", function(e2, t4, r2) {
    ...
    }), ye(ke(s), "setSelected", function(e2, t4, r2, n) {
      var o2 = e2;
      if (s.props.showYearPicker) {
        if (null !== o2 && ct(getYear(o2), s.props))
          return;
    ...
    }), ye(ke(s), "setPreSelection", function(e2) {
    ...
    }), ye(ke(s), "handleTimeChange", function(e2) {
    ...
    }), ye(ke(s), "onInputKeyDown", function(e2) {
      ...
      if (s.state.open || s.props.inline || s.props.preventOpenOnFocus) {
        if (s.state.open) {
          ...
          "Enter" === t4 ? (e2.preventDefault(), s.inputOk() && s.state.lastPreSelectChange === Gt ? (s.handleSelect(n, e2), !s.props.shouldCloseOnSelect && s.setPreSelection(n)) : s.setOpen(false)) : "Escape" === t4 && (e2.preventDefault(), s.setOpen(false)), s.inputOk() || s.props.onInputError({ code: 1, msg: "Date input not valid." });
        }
      } else
        "ArrowDown" !== t4 && "ArrowUp" !== t4 && "Enter" !== t4 || s.onInputClick();
    }), ye(ke(s), "onPortalKeyDown", function(e2) {
    ...
    }), ye(ke(s), "onDayKeyDown", function(e2) {
      s.props.onKeyDown(e2);
      ...
      if ("Enter" === t4)
        ...
        if (e2.preventDefault(), s.setState({ lastPreSelectChange: Gt }), s.props.adjustDateOnChange && s.setSelected(n), s.setPreSelection(n), s.props.inline) {
    ...
    }), ye(ke(s), "onPopperKeyDown", function(e2) {
      "Escape" === e2.key && (e2.preventDefault(), s.setState({ preventFocus: true }, function() {
        s.setOpen(false), setTimeout(function() {
          s.setFocus(), s.setState({ preventFocus: false });
        });
      }));
    }), ye(ke(s), "onClearClick", function(e2) {
      ...
      return s.props.inline || s.isCalendarOpen() ? import_react2.default.createElement(Ut, { ref: function(e2) {
        s.calendar = e2;
      ...
      return t4 = s.props.selectsRange ? "Selected start date: ".concat(Le(s.props.startDate, { dateFormat: a2, locale: o2 }), ". ").concat(s.props.endDate ? "End date: " + Le(s.props.endDate, { dateFormat: a2, locale: o2 }) : "") : s.props.showTimeSelectOnly ? "Selected time: ".concat(Le(s.props.selected, { dateFormat: n, locale: o2 })) : s.props.showYearPicker ? "Selected year: ".concat(Le(s.props.selected, { dateFormat: "yyyy", locale: o2 })) : s.props.showMonthYearPicker ? "Selected month: ".concat(Le(s.props.selected, { dateFormat: "MMMM yyyy", locale: o2 })) : s.props.showQuarterYearPicker ? "Selected quarter: ".concat(Le(s.props.selected, { dateFormat: "yyyy, QQQ", locale: o2 })) : "Selected date: ".concat(Le(s.props.selected, { dateFormat: a2, locale: o2 })), import_react2.default.createElement("span", { role: "alert", "aria-live": "polite", className: "react-datepicker__aria-live" }, s.state.isRenderAriaLiveMessage && t4);
    }), ye(ke(s), "renderDateInput", function() {
      var t4, n = (0, import_classnames.default)(s.props.className, ye({}, "react-datepicker-ignore-onclickoutside", s.state.open)), o2 = s.props.customInput || import_react2.default.createElement("input", { type: "text" }), a2 = s.props.customInputRef || "ref", i = "string" == typeof s.props.value ? s.props.value : "string" == typeof s.state.inputValue ? s.state.inputValue : s.props.selectsRange ? function(e2, t5, r2) {
        if (!e2)
          return "";
        var n2 = Le(e2, r2), o3 = t5 ? Le(t5, r2) : "";
        return "".concat(n2, " - ").concat(o3);
      }(s.props.startDate, s.props.endDate, s.props) : Le(s.props.selected, s.props);
      return import_react2.default.cloneElement(o2, (ye(t4 = {}, a2, function(e2) {
        s.input = e2;
      }), ye(t4, "value", i), ye(t4, "onBlur", s.handleBlur), ye(t4, "onChange", s.handleChange), ye(t4, "onClick", s.onInputClick), ye(t4, "onFocus", s.handleFocus), ye(t4, "onKeyDown", s.onInputKeyDown), ye(t4, "id", s.props.id), ye(t4, "name", s.props.name), ye(t4, "form", s.props.form), ye(t4, "autoFocus", s.props.autoFocus), ye(t4, "placeholder", s.props.placeholderText), ye(t4, "disabled", s.props.disabled), ye(t4, "autoComplete", s.props.autoComplete), ye(t4, "className", (0, import_classnames.default)(o2.props.className, n)), ye(t4, "title", s.props.title), ye(t4, "readOnly", s.props.readOnly), ye(t4, "required", s.props.required), ye(t4, "tabIndex", s.props.tabIndex), ye(t4, "aria-describedby", s.props.ariaDescribedBy), ye(t4, "aria-invalid", s.props.ariaInvalid), ye(t4, "aria-labelledby", s.props.ariaLabelledBy), ye(t4, "aria-required", s.props.ariaRequired), t4));
  ...
  return fe(a, [{ key: "componentDidMount", value: function() {
    ...
    var r2, n;
    e2.inline && (r2 = e2.selected, n = this.props.selected, r2 && n ? getMonth(r2) !== getMonth(n) || getYear(r2) !== getYear(n) : r2 !== n) && this.setPreSelection(this.props.selected), void 0 !== this.state.monthSelectedIn && e2.monthsShown !== this.props.monthsShown && this.setState({ monthSelectedIn: 0 }), e2.highlightDates !== this.props.highlightDates && this.setState({ highlightDates: kt(this.props.highlightDates) }), t3.focused || $e(e2.selected, this.props.selected) || this.setState({ inputValue: null }), t3.open !== this.state.open && (false === t3.open && true === this.state.open && this.props.onCalendarOpen(), true === t3.open && false === this.state.open && this.props.onCalendarClose());
  } }, { key: "componentWillUnmount", value: function() {
    ...
    if (this.props.withPortal) {
      var r2 = this.state.open ? import_react2.default.createElement(Vt, { enableTabLoop: this.props.enableTabLoop }, import_react2.default.createElement("div", { className: "react-datepicker__portal", tabIndex: -1, onKeyDown: this.onPortalKeyDown }, t3)) : null;
