    ...
    !function(t, e) {
      ...
      return (() => {
        ...
        const N = function(t3, e3, r3) {
          ...
          function v2() {
            ...
            if (o2 = arguments, n2 = this, u2 = t4, r4) {
              ...
              if (p2)
                return clearTimeout(c2), c2 = setTimeout(g2, e3), _2(u2);
            }
        ...
        const Pe = function(t3, e3) {
          ...
          for (var u2 in t3)
            !e3 && !Ce.call(t3, u2) || s2 && ("length" == u2 || n2 && ("offset" == u2 || "parent" == u2) || i2 && ("buffer" == u2 || "byteLength" == u2 || "byteOffset" == u2) || fe(u2, c2)) || a2.push(u2);
          return a2;
        };
        ...
        const Ie = function(t3) {
          ...
          for (var r3 in Object(t3))
            Re.call(t3, r3) && "constructor" != r3 && e3.push(r3);
          return e3;
        };
        ...
        const Ne = function(t3) {
          ...
          var e3 = Te(t3), r3 = [];
          for (var o2 in t3)
            ("constructor" != o2 || !e3 && Fe.call(t3, o2)) && r3.push(o2);
          return r3;
        };
        ...
        const mo = function t3(e3, r3, o2, n2, i2, a2) {
          ...
          if (o2 && (c2 = i2 ? o2(e3, n2, i2, a2) : o2(e3)), void 0 !== c2)
            return c2;
          if (!s(e3))
            return e3;
          var l2 = se(e3);
          if (l2) {
            ...
            if (p2 == bo || p2 == _o || f2 && !i2) {
              if (c2 = h2 || f2 ? {} : ro(e3), !u2)
                return h2 ? or(e3, ke(c2, e3)) : Ze(e3, Me(c2, e3));
            } else {
              if (!vo[p2])
                return i2 ? e3 : {};
              c2 = Zr(e3, p2, u2);
        ...
        class No extends zo {
          ...
          add(t3) {
            ...
            return Promise.all(e3.map((t4) => this._actionQueues.enqueue(t4.id, () => {
              ...
              if ("editor" === t4.type)
                return e4 = new Mo(this._watchdogConfig), e4.setCreator(t4.creator), e4._setExcludedProperties(this._contextProps), t4.destructor && e4.setDestructor(t4.destructor), this._watchdogs.set(t4.id, e4), e4.on("error", (r3, { error: o2, causesRestart: n2 }) => {
